export const results = {
    ISTJ: {
        ...
        description: {
            ko: [
                "꼼꼼하고 책임감이 정말 강해요.",
                "약속을 잘 지키고 규칙을 중요하게 생각해요.",
                "정리정돈을 잘해서 주변이 항상 깨끗해요.",
                "시작한 일은 끝까지 해내는 끈기가 있어요."
            ],
            en: [
                "Very thorough and has a strong sense of responsibility.",
                "Keeps promises well and values rules.",
                "Always keeps things organized and clean.",
                "Has the persistence to finish what was started."
            ],
            es: [
                "Muy minucioso y con gran sentido de la responsabilidad.",
    ...
    ISFJ: {
        ...
        description: {
            ko: [
                "친구들을 잘 챙겨주는 따뜻한 마음씨를 가졌어요.",
                "조용하지만 친구들에게는 언제나 든든한 편이에요.",
                "기억력이 좋아서 친구들의 사소한 것도 잘 기억해요.",
                "다른 사람의 감정을 잘 이해하고 공감해요."
            ],
            en: [
                "Has a warm heart that takes good care of friends.",
                "Quiet but always reliable to friends.",
                "Has a good memory and remembers small details about friends.",
                "Understands and empathizes well with others' feelings."
            ],
            es: [
                "Tiene un corazón cálido que cuida bien de los amigos.",
    ...
    INFJ: {
        ...
        description: {
            ko: [
                "친구의 마음을 깊이 이해해주는 지혜로운 친구예요.",
                "혼자만의 시간을 가지며 생각하는 것을 좋아해요.",
                "더 좋은 세상을 만드는 데 관심이 많아요.",
                "상상력이 풍부하고 의미 있는 대화를 좋아해요."
            ],
            en: [
                "A wise friend who deeply understands friends' hearts.",
                "Likes to have alone time to think.",
                "Interested in making the world a better place.",
                "Imaginative and loves meaningful conversations."
            ],
            es: [
                "Un amigo sabio que entiende profundamente los corazones de los amigos.",
    ...
    INTJ: {
        ...
        description: {
            ko: [
                "어려운 문제가 생겨도 해결 방법을 잘 찾아내요.",
                "궁금한 것은 책을 읽거나 찾아보며 깊이 탐구해요.",
                "미리 계획을 세우고 실천하는 것을 좋아해요.",
                "논리적으로 생각하고 효율적인 방법을 찾아요."
            ],
            en: [
                "Finds solutions well even when difficult problems arise.",
                "Reads or researches deeply about curious things.",
                "Likes to plan ahead and put it into action.",
                "Thinks logically and finds efficient methods."
            ],
            es: [
                "Encuentra soluciones bien incluso cuando surgen problemas difíciles.",
    ...
    ISTP: {
        ...
        description: {
            ko: [
                "손재주가 뛰어나고 무언가를 만드는 걸 좋아해요.",
                "상황을 빠르게 판단하고 문제를 잘 해결해요.",
                "자유롭게 탐험하고 관찰하는 것을 즐겨요.",
                "도구를 사용하는 요령이 아주 뛰어나요."
            ],
            en: [
                "Has great dexterity and loves making things.",
                "Judges situations quickly and solves problems well.",
                "Enjoys exploring and observing freely.",
                "Very skilled at using tools."
            ],
            es: [
                "Tiene gran destreza y le encanta hacer cosas.",
    ...
    ISFP: {
        ...
        description: {
            ko: [
                "아름다운 것을 좋아하고 예술적 감각이 뛰어나요.",
                "말보다는 그림이나 노래로 표현하는 걸 좋아해요.",
                "다정하고 겸손하며 다른 사람을 배려해요.",
                "자유로운 영혼을 가지고 있어 구속받는 건 싫어해요."
            ],
            en: [
                "Loves beautiful things and has great artistic sense.",
                "Prefers expressing through drawing or singing rather than words.",
                "Kind, humble, and considerate of others.",
                "Has a free spirit and dislikes being constrained."
            ],
            es: [
                "Ama las cosas bellas y tiene gran sentido artístico.",
    ...
    INFP: {
        ...
        description: {
            ko: [
                "마음껏 상상의 나래를 펼치는 것을 좋아해요.",
                "겉으로는 조용해 보이지만 속마음은 열정이 넘쳐요.",
                "나만의 소중한 신념과 가치관을 가지고 있어요.",
                "아름다운 이야기와 꿈꾸는 세상을 사랑해요."
            ],
            en: [
                "Loves to spread wings of imagination freely.",
                "Looks quiet on the outside but full of passion inside.",
                "Has own precious beliefs and values.",
                "Loves beautiful stories and the dreaming world."
            ],
            es: [
                "Le encanta desplegar las alas de la imaginación libremente.",
    ...
    INTP: {
        ...
        description: {
            ko: [
                "세상 모든 것이 궁금한 호기심 많은 발명가예요.",
                "논리적으로 분석하고 원리를 파악하는 걸 좋아해요.",
                "혼자서 곰곰이 생각하는 시간을 즐겨요.",
                "기발한 아이디어로 친구들을 놀라게 해요."
            ],
            en: [
                "A curious inventor wondering about everything in the world.",
                "Likes to analyze logically and understand principles.",
                "Enjoys time thinking deeply alone.",
                "Surprises friends with brilliant ideas."
            ],
            es: [
                "Un inventor curioso que se pregunta sobre todo en el mundo.",
    ...
    ESTP: {
        ...
        description: {
            ko: [
                "새로운 것에 도전하는 것을 즐기는 모험가예요.",
                "에너지가 넘치고 행동이 아주 빨라요.",
                "친구들과 어울려 노는 것을 좋아하고 인기가 많아요.",
                "문제가 생기면 바로바로 해결해내는 능력이 있어요."
            ],
            en: [
                "An adventurer who enjoys challenging new things.",
                "Full of energy and acts very quickly.",
                "Likes hanging out with friends and is popular.",
                "Has the ability to solve problems right away when they arise."
            ],
            es: [
                "Un aventurero que disfruta desafiando cosas nuevas.",
    ...
    ESFP: {
        ...
        description: {
            ko: [
                "어디서든 즐거움과 웃음을 만들어내는 분위기 메이커예요.",
                "친구들과 함께 춤추고 노래하는 것을 좋아해요.",
                "새로운 경험을 하는 것을 두려워하지 않아요.",
                "남의 이목을 끄는 매력이 철철 넘쳐요."
            ],
            en: [
                "A mood maker who creates fun and laughter anywhere.",
                "Likes dancing and singing with friends.",
                "Not afraid of having new experiences.",
                "Overflowing with charm that attracts others' attention."
            ],
            es: [
                "Un creador de ambiente que crea diversión y risas en cualquier lugar.",
    ...
    ENFP: {
        ...
        description: {
            ko: [
                "새로운 친구를 좋아하고 누구와도 잘 어울려요.",
                "상상력과 열정이 넘쳐서 항상 에너지가 가득해요.",
                "긍정적인 에너지로 주변 친구들을 기분 좋게 해요.",
                "자유롭게 생각하고 재미있는 일을 꾸미는 걸 좋아해요."
            ],
            en: [
                "Likes new friends and gets along well with anyone.",
                "Full of imagination and passion, always full of energy.",
                "Makes friends around feel good with positive energy.",
                "Likes to think freely and plan fun things."
            ],
            es: [
                "Le gustan los nuevos amigos y se lleva bien con cualquiera.",
    ...
    ENTP: {
        ...
        description: {
            ko: [
                "다른 사람과 이야기 나누고 토론하는 걸 좋아해요.",
                "아는 것이 많고 유머 감각이 뛰어나요.",
                "어려운 문제에 도전하는 것을 즐겨요.",
                "말솜씨가 좋아서 친구들을 설득하는 걸 잘해요."
            ],
            en: [
                "Likes talking and debating with others.",
                "Knows a lot and has a great sense of humor.",
                "Enjoys challenging difficult problems.",
                "Good at speaking and persuasive to friends."
            ],
            es: [
                "Le gusta hablar y debatir con los demás.",
    ...
    ESTJ: {
        ...
        description: {
            ko: [
                "책임감이 강하고 친구들을 이끄는 리더십이 있어요.",
                "계획을 세우고 규칙을 지키는 것을 중요하게 생각해요.",
                "솔직하고 결단력이 있어서 친구들이 믿고 따라요.",
                "목표를 정하면 끝까지 노력해서 이루어내요."
            ],
            en: [
                "Strong sense of responsibility and leadership to lead friends.",
                "Values ​​planning and following rules.",
                "Honest and decisive, so friends trust and follow.",
                "Sets a goal and works hard to achieve it until the end."
            ],
            es: [
                "Fuerte sentido de responsabilidad y liderazgo para guiar a los amigos.",
    ...
    ESFJ: {
        ...
        description: {
            ko: [
                "주변 사람들을 잘 챙기고 돕는 걸 좋아해요.",
                "친구들의 기분을 잘 살피고 사이좋게 지내도록 도와요.",
                "우정을 소중히 여기고 친구와 함께하는 시간을 즐겨요.",
                "책임감이 강하고 다른 사람에게 친절해요."
            ],
            en: [
                "Likes taking care of and helping people around.",
                "Looks out for friends' moods and helps them get along.",
                "Values ​​friendship and enjoys time with friends.",
                "Strong sense of responsibility and kind to others."
            ],
            es: [
                "Le gusta cuidar y ayudar a las personas de alrededor.",
    ...
    ENFJ: {
        ...
        description: {
            ko: [
                "친구들이 성장하도록 돕고 이끄는 것을 좋아해요.",
                "긍정적인 에너지로 친구들에게 용기를 줘요.",
                "친구들과 깊은 우정을 나누는 것을 중요하게 생각해요.",
                "모두가 행복해질 수 있는 방법을 찾으려고 노력해요."
            ],
            en: [
                "Likes helping and leading friends to grow.",
                "Gives courage to friends with positive energy.",
                "Considers sharing deep friendship with friends important.",
                "Tries to find a way for everyone to be happy."
            ],
            es: [
                "Le gusta ayudar y guiar a los amigos para que crezcan.",
    ...
    ENTJ: {
        ...
        description: {
            ko: [
                "목표를 향해 돌진하는 대담한 리더십이 있어요.",
                "어려운 일이 닥쳐도 자신감 있게 도전해요.",
                "미래를 내다보는 눈이 있고 계획을 잘 세워요.",
                "팀이 이길 수 있도록 전략을 짜고 이끌어요."
            ],
            en: [
                "Has bold leadership rushing towards the goal.",
                "Challenges confidently even when difficulties arise.",
                "Has an eye for the future and plans well.",
                "Strategizes and leads the team to win."
            ],
            es: [
                "Tiene un liderazgo audaz que se precipita hacia la meta.",
